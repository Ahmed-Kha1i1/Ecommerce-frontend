function ItemSkeleton() {
  return (
    <div
      role="status"
      className="mt-5 animate-pulse space-y-8 md:flex md:items-center md:space-x-8 md:space-y-0 rtl:space-x-reverse"
    >
      <div className="flex h-48 w-full items-center justify-center rounded-sm bg-gray-300 sm:w-96">
        <svg
